...
export function Affectation(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#FF6B6B" />
      <path
        d="M22.5 18.75a1.5 1.5 0 011.5 1.5v10.94l3.44-3.44a1.5 1.5 0 112.12 2.12l-5.42 5.42a1.5 1.5 0 01-2.12 0l-5.42-5.42a1.5 1.5 0 112.12-2.12l3.44 3.44V20.25a1.5 1.5 0 011.5-1.5z"
        fill="#fff"
      />
      <path
        d="M35.5 39.25a1.5 1.5 0 01-1.5-1.5V26.81l-3.44 3.44a1.5 1.5 0 11-2.12-2.12l5.42-5.42a1.5 1.5 0 012.12 0l5.42 5.42a1.5 1.5 0 11-2.12 2.12l-3.44-3.44V37.75a1.5 1.5 0 01-1.5 1.5z"
        fill="#fff"
      />
    </svg>
  );
...
export function Category(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M26.5 17.25h.02c.93 0 1.82.37 2.48 1.03l10.82 10.82a3.51 3.51 0 010 4.96l-7.16 7.16a3.51 3.51 0 01-4.96 0L17.16 30.4a3.5 3.5 0 01-1.02-2.48l.01-7.99A2.67 2.67 0 0118.67 17.25H26.5zm.02 2H18.67a.67.67 0 00-.66.67l-.01 7.99c0 .44.18.87.49 1.18l10.82 10.82a1.51 1.51 0 002.13 0l7.16-7.16a1.51 1.51 0 000-2.13L27.48 20.1a1.5 1.5 0 00-1.11-.55z"
        fill="#fff"
      />
      <path
        d="M23 24.75a1 1 0 100-2 1 1 0 000 2z"
        fill="#fff"
      />
    </svg>
  );
