...
export function Monitor(props: PropsType) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path fillRule="evenodd" clipRule="evenodd" d="M2.25 5A2.75 2.75 0 015 2.25h14A2.75 2.75 0 0121.75 5v10A2.75 2.75 0 0119 17.75H5A2.75 2.75 0 012.25 15V5zM5 3.75c-.69 0-1.25.56-1.25 1.25v10c0 .69.56 1.25 1.25 1.25h14c.69 0 1.25-.56 1.25-1.25V5c0-.69-.56-1.25-1.25-1.25H5z" fill="currentColor"/>
      <path d="M8 21.25a.75.75 0 000 1.5h8a.75.75 0 000-1.5H8z" fill="currentColor"/>
      <path d="M12 18.25a.75.75 0 01.75.75v2a.75.75 0 01-1.5 0v-2a.75.75 0 01.75-.75z" fill="currentColor"/>
    </svg>
  );
}
...
export function Wrench(props: PropsType) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path fillRule="evenodd" clipRule="evenodd" d="M14.293 2.293a1 1 0 011.414 0l1 1a4 4 0 01-5.414 5.828l-7.586 7.586a2 2 0 002.828 2.829L14.12 12l1.707 1.707-7.587 7.586a4 4 0 01-5.656-5.656l7.586-7.586A4 4 0 0114.293 2.293z" fill="currentColor"/>
    </svg>
  );
}
...
export function Building(props: PropsType) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path fillRule="evenodd" clipRule="evenodd" d="M3.25 21a.75.75 0 01.75-.75h16a.75.75 0 010 1.5H4a.75.75 0 01-.75-.75z" fill="currentColor"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M4 3.25A1.75 1.75 0 002.25 5v16a.75.75 0 001.5 0V5c0-.138.112-.25.25-.25h12c.138 0 .25.112.25.25v16a.75.75 0 001.5 0V5A1.75 1.75 0 0016 3.25H4z" fill="currentColor"/>
      <path d="M6.25 8A.75.75 0 017 7.25h2a.75.75 0 010 1.5H7A.75.75 0 016.25 8zM6.25 12A.75.75 0 017 11.25h2a.75.75 0 010 1.5H7A.75.75 0 016.25 12zM11 7.25a.75.75 0 000 1.5h2a.75.75 0 000-1.5h-2zM10.25 12a.75.75 0 01.75-.75h2a.75.75 0 010 1.5h-2a.75.75 0 01-.75-.75zM8.25 16a.75.75 0 01.75-.75h4a.75.75 0 010 1.5H9a.75.75 0 01-.75-.75z" fill="currentColor"/>
      <path fillRule="evenodd" clipRule="evenodd" d="M17.25 9A2.75 2.75 0 0120 6.25h1a.75.75 0 01.75.75v14a.75.75 0 01-1.5 0V7.75H20A1.25 1.25 0 0018.75 9v12a.75.75 0 01-1.5 0V9z" fill="currentColor"/>
    </svg>
  );
}
...
export function Tag(props: PropsType) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path fillRule="evenodd" clipRule="evenodd" d="M10.994 2.25h.012c.698 0 1.367.277 1.859.769l8.116 8.116a2.632 2.632 0 010 3.718l-5.372 5.372a2.632 2.632 0 01-3.718 0L3.775 12.11a2.625 2.625 0 01-.768-1.858l.006-5.997A2.003 2.003 0 015 2.25h5.994zm.012 1.5H5.004a.5.5 0 00-.497.503l-.006 5.997c0 .332.132.65.366.884l8.116 8.116a1.132 1.132 0 001.6 0l5.372-5.372a1.132 1.132 0 000-1.6l-8.116-8.116a1.125 1.125 0 00-.833-.412z" fill="currentColor"/>
      <path d="M7.5 8.25a.75.75 0 100-1.5.75.75 0 000 1.5z" fill="currentColor"/>
    </svg>
  );
}

export function Swap(props: PropsType) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M7.5 3.75a.75.75 0 01.75.75v13.19l2.22-2.22a.75.75 0 111.06 1.06l-3.5 3.5a.75.75 0 01-1.06 0l-3.5-3.5a.75.75 0 111.06-1.06l2.22 2.22V4.5a.75.75 0 01.75-.75z" fill="currentColor"/>
      <path d="M16.5 20.25a.75.75 0 01-.75-.75V6.31l-2.22 2.22a.75.75 0 11-1.06-1.06l3.5-3.5a.75.75 0 011.06 0l3.5 3.5a.75.75 0 11-1.06 1.06l-2.22-2.22V19.5a.75.75 0 01-.75.75z" fill="currentColor"/>
    </svg>
  );
}
